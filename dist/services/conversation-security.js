...
exports.ConversationSecurityService = void 0;
const logger_1 = __importDefault(require("../utils/logger"));
class ConversationSecurityService {
    constructor() {
        this.conversationHistory = [];
        this.offTopicCount = 0;
        this.maxOffTopicAttempts = 3;
        this.movingRelatedKeywords = [
     ...
     */
    isMovingRelated(content) {
        const lowerContent = content.toLowerCase();
        // Check for moving-related keywords
        const hasMovingKeywords = this.movingRelatedKeywords.some(keyword => lowerContent.includes(keyword));
     ...
     */
    recordConversationTurn(content) {
        ...
        if (!isOnTopic) {
            this.offTopicCount++;
            logger_1.default.warn(`Off-topic conversation detected. Count: ${this.offTopicCount}/${this.maxOffTopicAttempts}`);
        }
...
- Always try to guide the conversation toward scheduling an appointment or providing moving-related assistance.`;
    ...
    reset() {
        this.conversationHistory = [];
        this.offTopicCount = 0;
        logger_1.default.info('Conversation security state reset');
    }
    /**
...
exports.ConversationSecurityService = ConversationSecurityService;
exports.default = ConversationSecurityService;
